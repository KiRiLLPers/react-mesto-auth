    ...
    <main className="main content__main">
      <section className="profile main__profile">
        <div className="profile__wrap">
          <button type="button" className="profile__avatar" onClick={onEditAvatar} style={{ backgroundImage: `url(${currentUser.user.avatar})` }} />
          <div className="profile__info">
            <h1 className="profile__full-name">{currentUser.user.name}</h1>
